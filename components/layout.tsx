          ...
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <Link href="/" className="flex items-center space-x-2">
                <Image src="/logo/cropped.png" alt="Semantic Map Logo" width={40} height={20} />
                <span className="text-xl font-semibold">Semantic Map</span>
              </Link>
              <nav className="hidden md:flex space-x-8">
                {/* <Link href="/product" className="text-sm hover:text-gray-300 transition-colors">
                  Product
                </Link> */}
              ...
              <div className="hidden md:block">
                <Button asChild variant="secondary" className="bg-white text-black hover:bg-gray-200 rounded-full px-4 py-2 text-sm font-semibold transition-all duration-300 ease-in-out">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-gray-900 bg-opacity-95 backdrop-blur-md">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                {/* <Link href="/product" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-800">
                  Product
                </Link> */}
                <Link href="/use-cases" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-800">
                  Use Cases
                </Link>
                <Link href="/pricing" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-800">
                  Pricing
                </Link>
                <Link href="/request-demo" className="block px-3 py-2 rounded-md text-base font-medium text-black bg-white hover:bg-gray-200">
                  Request a Demo
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800">
              <div className="flex items-center space-x-2 mb-4 md:mb-0">
                <Image src="/logo/cropped.png" alt="Semantic Map Logo" width={24} height={12} />
                <span className="text-sm font-semibold text-gray-300">Semantic Map</span>
              </div>
